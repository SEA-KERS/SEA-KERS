      ...
      <div className="w-full bg-[var(--bg-surface)]/95 backdrop-blur-md border-2 border-[var(--border-main)] px-4 md:px-6 h-14 md:h-16 flex items-center justify-between shadow-[4px_4px_0px_rgba(0,0,0,0.8)]">
        ...
        <div className="flex items-center gap-2 shrink-0">
          <button
            ...
            className="hidden bg-[#da261c] px-3 py-1.5 font-mono text-xs font-bold text-white border-2 border-black shadow-[1.5px_1.5px_0px_rgba(0,0,0,0.8)] transition-all active:translate-y-0.5 sm:block"
          >
            JOIN
          </button>
          <button
